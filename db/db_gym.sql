...
-- Tiempo de generación: 16-12-2023 a las 10:16:38
...
(7, 'General', 'General', 'General', 'General', 'General01@General01.com', '2000-01-01');
...
(1, '05:30:00', '12:59:00', 'Mañana'),
(2, '13:00:00', '16:59:00', 'Media Tarde'),
(3, '17:00:00', '21:00:00', 'Noche'),
(4, '05:30:00', '09:00:00', 'Media mañana'),
(6, '21:00:00', '23:59:00', 'Media Noche');
...
CREATE TABLE `instructores` (
  ...
  `fecha_nacimiento` date NOT NULL,
  `especializacion` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(2, 'Instructor 2', 'Instructor 2', 'Instructor 2', '923145766', 'Instructor2@Instructor2.com', '1991-12-11', 'Full Peso', NULL),
(3, 'Instructor 3', 'Instructor 3', 'Instructor 3', '862497135', 'instructor3@Instructor3.com', '1983-06-15', 'Danza', NULL),
(5, 'Jose Fernando', 'Rodrigues Rodrigo', 'Jr. Serafin Filomeno', '33333333', 'elmasfit@gmail.com', '2003-06-18', 'Aerobicos ', NULL);
...
CREATE TABLE `membresias` (
  ...
  `nombre_membresia` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `precio` decimal(10,2) NOT NULL,
  `beneficios` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(3, 'Ahorrador', 80.00, 'GYM POR LA MAÑANA');
...
--
-- Volcado de datos para la tabla `pago_membresias`
--

INSERT INTO `pago_membresias` (`ID_pago_mem`, `fecha_pago`, `cantidad`, `metodo_pago`, `ID_miembro`) VALUES
(1, '2023-12-09', 3, 'efectivo', 1),
(2, '2023-12-10', 2, 'efectivo', 3),
(3, '2023-12-16', 1, 'efectivo', 6),
(4, '2023-12-16', 1, 'tarjeta', 5);
...
CREATE TABLE `productos` (
  `ID_producto` int NOT NULL,
  `nombre_producto` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Proteina', 'Proteina de calidad', 150.00, 10),
(2, 'Trembolona', 'Pa ser más fuertes', 500.00, 2),
(3, 'Agua San Luis', 'Agua San Luis Mineral', 2.50, 7),
(5, 'Suplemento', 'Suplmento CR3', 52.50, 100);
...
(4, '2023-12-07', 'efectivo', 6),
(5, '2023-12-10', 'efectivo', 7),
(6, '2023-12-10', 'efectivo', 7),
(7, '2023-12-10', 'efectivo', 7),
(8, '2023-12-10', 'tarjeta', 7),
(9, '2023-12-10', 'tarjeta', 7),
(10, '2023-12-10', 'efectivo', 7),
(11, '2023-12-10', 'efectivo', 7),
(12, '2023-12-10', 'efectivo', 1),
(13, '2023-12-10', 'efectivo', 1),
(14, '2023-12-10', 'efectivo', 1),
(15, '2023-12-10', 'efectivo', 1),
(16, '2023-12-10', 'efectivo', 1),
(17, '2023-12-10', 'efectivo', 1),
(18, '2023-12-10', 'efectivo', 7),
(19, '2023-12-10', 'efectivo', 7),
(20, '2023-12-10', 'tarjeta', 7),
(21, '2023-12-10', 'efectivo', 7),
(22, '2023-12-10', 'efectivo', 7),
(23, '2023-12-10', 'efectivo', 7),
(24, '2023-12-10', 'tarjeta', 7),
(25, '2023-12-10', 'efectivo', 1),
(26, '2023-12-10', 'efectivo', 1),
(27, '2023-12-16', 'efectivo', 7),
(28, '2023-12-16', 'efectivo', 7);
...
--
ALTER TABLE `detalles_venta`
  MODIFY `ID_detalle_venta` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT de la tabla `enseña_en`
--
ALTER TABLE `enseña_en`
  MODIFY `ID_enseña_en` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `horarios`
--
ALTER TABLE `horarios`
  MODIFY `ID_horario` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `inscripciones`
--
ALTER TABLE `inscripciones`
  MODIFY `ID_inscripcion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `instructores`
--
ALTER TABLE `instructores`
  MODIFY `ID_instructor` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `membresias`
--
ALTER TABLE `membresias`
  MODIFY `ID_membresia` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `pago_membresias`
  MODIFY `ID_pago_mem` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
